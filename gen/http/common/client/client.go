...
// HealthCheck returns an endpoint that makes HTTP requests to the common
// service health_check server.
func (c *Client) HealthCheck() goa.Endpoint {
	var (
		encodeRequest  = EncodeHealthCheckRequest(c.encoder)
	...
	return func(ctx context.Context, v interface{}) (interface{}, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("common", "health_check", err)
		}
